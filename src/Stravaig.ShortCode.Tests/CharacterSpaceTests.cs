...
namespace Stravaig.ShortCode.Tests
{
    ...
    public class CharacterSpaceTests
    {
        ...
        {
            ArgumentException ex = Should.Throw<ArgumentException>(() => new CharacterSpace(value));
        ...
        {
            ArgumentException ex = Should.Throw<ArgumentException>(() => new CharacterSpace("1"));
            ex.ParamName.ShouldBe("characterSpace");
        ...
        {
            var characterSpace = new CharacterSpace(charSpace);
        ...
        {
            var cs = new CharacterSpace(CharacterSpace.Digits);
